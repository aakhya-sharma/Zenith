        ...
        <div className='container mt-4'>
            <div className='row p-5'>
                ...
                <div className='col-6 mt-5 text-center'>
                    <img src='media/images/ecosystem.png' alt='Trust' className='img-fluid'/>
                    <br />
                    <a href='/' className='text-decoration-none'>Explore our products <i className="fa fa-arrow-right" aria-hidden="true"></i></a>
                    &nbsp; &nbsp; &nbsp; &nbsp;
                    <a href='/' className='text-decoration-none'>Try Kite demo <i className="fa fa-arrow-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
     );
